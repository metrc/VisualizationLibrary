...
consort_diagram_nsaid_publication <- function(analytic, outcome_day=365){
  ...
  inappropriately_enrolled <- sum(rand_df$adjudicated_inappropriate_enrollment, na.rm = TRUE)
  late_ineligible <- sum(rand_df$adjudicated_late_ineligible, na.rm = TRUE)
  late_refusal <- sum(rand_df$adjudicated_late_refusal, na.rm = TRUE)
  physician_withdrawn <- sum(rand_df$adjudicated_physician_withdrawn, na.rm = TRUE)
  ...
  no_df_row <- ifelse(no_definitive_fixation > 0,
                      paste0('<TR><TD ALIGN="LEFT">', no_definitive_fixation, ' Did not complete definitive fixation</TD></TR>'),
                      '')
      ...
      box2 [style="filled", fillcolor="white", color="black", pos="2,-1.3!", shape = box, width=2.4, height=.5, labeljust=l,
        label = <
          <TABLE BORDER="0" CELLBORDER="0" CELLPADDING="0">
            ...
            <TR><TD ALIGN="LEFT">', late_refusal, ' Were determined to be late refusals by</TD></TR>
            <TR><TD ALIGN="LEFT">blinded adjudication committee</TD></TR>
            <TR><TD ALIGN="LEFT">', physician_withdrawn, ' Were determined to be physician</TD></TR>
