      ...
      box2 [style="rounded,filled", fillcolor="#a4d3ee", pos="2,-0.5!", shape = box, width=2.4, height=.5, labeljust=l,
        label = <
          <TABLE BORDER="0" CELLBORDER="0" CELLPADDING="0">
            ...
            <TR><TD ALIGN="LEFT" STYLE="padding-left:20px;">     ', died, ' - Died prior to 365 days</TD></TR>
            <TR><TD ALIGN="LEFT" STYLE="padding-left:20px;">     ', withdrew, ' - Withdrew prior to 365 days</TD></TR>
